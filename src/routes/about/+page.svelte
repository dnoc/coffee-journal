<div class="p-4">
	<h1 class="text-xl">Whoa!</h1>
	<p>I started this little webapp to test out a few things:</p>
	<ul class="mb-12">
		<li>How to use SvelteKit</li>
		<li>How to create a progressive webapp</li>
		<li>How to use Github Copilot</li>
		<li>How to use TailwindCSS</li>
		<li>My buddy Cody asked if I could make a coffee journal app</li>
	</ul>
