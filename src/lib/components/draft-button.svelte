...
<button
	...
	class="text-amber-50 rotate-30 bg-yellow-800 hover:bg-yellow-700 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-full p-2.5 inline-flex items-center"
>
	<svg
		fill="currentColor"
		width="20px"
